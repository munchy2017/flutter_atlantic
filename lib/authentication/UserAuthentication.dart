...
import 'package:financial_app/style/theme.dart' as Theme;
import 'package:financial_app/utils/bubble_indication_painter.dart';
...
class _LoginPageState extends State<UserAuthentication>
  ...
  Future userRegistration() async{
    ...
    String policyNo = signupEmailController.text;
    String password = signupPasswordController.text;

    // SERVER API URL
    var url = 'http://192.168.43.157/apps/Atlantic_Dashboard/app_api/user_registration.php';

    // Store all data with Param Name.
    var data = {'name': name, 'policyNo': policyNo, 'password' : password};
