...
class _LoginState extends State<Logregister> {
  ...
  login() async {
    final response = await http
        .post("http://10.0.2.2/apps/Atlantic_Dashboard/app_api/api_verification.php", body: {
      "flag": 1.toString(),
      "email": email,
      "password": password,
    ...
    //int value=int.parse(data['value'].toString());
    ...
    if (value == 1) {
      setState(() {
        ...
        savePref(value, emailAPI, nameAPI, mobileAPI, id);
      });
      print(message);
      loginToast(message);
  ...
  savePref(int value, String email, String name,String mobile, String id) async {
